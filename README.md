...
Welcome to the repository for the application portal [website](https://ansok.raysforexcellence.se/) for the organization [Rays for excellence](raysforexcellence.se), created by [Digital Ungdom](www.digitalungdom.se). The front-end repository is [infrarays.se](https://github.com/digitalungdom-se/infrarays.se). A development front-end server is set up at [dev--infrarays.netlify.app](https://dev--infrarays.netlify.app) and the development API is found at [devapi.infrarays.digitalungdom.se](https://devapi.infrarays.digitalungdom.se).
