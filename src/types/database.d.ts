 ...
 * $ schemats generate -c postgres://username:password@localhost:6666/infrarays_test -t knex_migrations -t surveys -t backemail -t emails -t tokens -t users -t grades -t sessions -t admins -t files -t knex_migrations_lock -s public
 *
 */
...
export interface grades {
    id: gradesFields.id;
    admin_id: gradesFields.admin_id;
    user_id: gradesFields.user_id;
    cv: gradesFields.cv;
